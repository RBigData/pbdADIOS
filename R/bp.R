...
#' @param adios.rank comm rank
#'
#' @return A list, where each component is a vector of values for a
#' variable. If start and count are not specified, all values will be
#' returned. TODO: return matrix or array with dimensions when apppropriate
